...
//
//    public PagedModel<PrListResponse> getPublicResumes(Pageable pageable) {
//        Sort sort = Sort.by(Sort.Order.desc("publishedAt"));
//        PageRequest pageRequest = PageRequest.of(pageable.getPageNumber(), pageable.getPageSize(), sort);
//        Page<PrListResponse> publishedResumes = publicResumesQueryRepository.getPublicResumes(pageRequest, sort);
//        return new PagedModel<>(publishedResumes);
//    }
//
//    @Transactional
//    public Long read(Long publicResumeId) {
//        Pr publicResume = publicResumesRepository.findById(publicResumeId).orElseThrow(
...
//                .viewCount(0)
//                .build();
//        publicResumesRepository.save(pr);
//    }
//
//    /**
//     * 이력 게시 취소 (pr 삭제)
...
//        Resume resume = new Resume(resumeId);
//        Pr pr = publicResumesRepository.findByResumeAndUser(resume, user).orElseThrow(
//                () -> new CustomException(ErrorType.UNPUBLISHED_RESUME)
//        );
//        publicResumesRepository.delete(pr);
//    }
//}
